...
var previousVersion = (0, child_process_1.execSync)('git describe --tags --abbrev=0 HEAD^').toString().trim();
// Get commit messages between previous version and current version
var commitMessages = (0, child_process_1.execSync)("git log ".concat(previousVersion, "..HEAD --pretty=format:\"- %s\"")).toString().trim();
// Get current date
